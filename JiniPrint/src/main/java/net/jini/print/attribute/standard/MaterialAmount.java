...
/**
 * This RECOMMENDED member attribute provides the estimated amount of material
 * that is available ("materials-col-database" and "materials-col-ready"
 * values), the estimated amount of material that is required ("materials-col"
 * values), or the actual amount of material that has been used
 * ("materials-col-actual" values).
 *
 * @author peter
 */
public class MaterialAmount extends IntegerSyntax implements Attribute {

    protected MaterialAmount(int i) {
	super(check(i));
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return MaterialAmount.class;
    }
