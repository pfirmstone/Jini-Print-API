 ...
 * @author peter
 */
public class FoldingSeq extends OneSetOfSyntax<Folding> implements Attribute {
    
    /**
     * 
     * @param foldingSequence the sequence of folds.
     */
    public FoldingSeq(List<Folding> foldingSequence){
	super(foldingSequence);
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return FoldingSeq.class;
    }
