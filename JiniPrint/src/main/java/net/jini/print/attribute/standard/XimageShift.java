 ...
 * rendered. The direction of shift MUST be along the x-axis of the Coordinate
 ...
 */
public class XimageShift extends Dimension implements DocAttribute, PrintRequestAttribute {
	...
	return XimageShift.class;
    }

    @Override
    public String getName() {
	return "x-image-shift";
    }
