...
/**
 * This CONDITIONALLY REQUIRED member attribute provides the diameter of the
 * filament in nanometers, with the value 0 being used for diameters less than
 * 0.000001mm. Printers that use filament materials MUST support this member
 * attribute.
 *
 * @author peter
 */
public class MaterialDiameter extends IntegerSyntax implements Attribute {

    public MaterialDiameter(int nanometres) {
	super(check(nanometres));
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return MaterialDiameter.class;
    }
