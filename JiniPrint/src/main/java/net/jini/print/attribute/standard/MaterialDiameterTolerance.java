...
/**
 * This member attribute provides a tolerance for the "material-diameter" value
 * in nanometers, with the value 0 being used for tolerances less than
 * 0.000001mm.
 *
 * @author peter
 */
public class MaterialDiameterTolerance extends IntegerSyntax implements Attribute {

    public MaterialDiameterTolerance(int nanometres) {
	super(check(nanometres));
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return MaterialDiameterTolerance.class;
    }

    @Override
    public String getName() {
	return "material-diameter-tolerance";
    }
