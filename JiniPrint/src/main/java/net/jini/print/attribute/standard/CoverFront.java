...
/**
 * CoverFront and CoverBack attributes specify how covers are to be applied to
 * each copy of each printed document within a job. Presence of the
 ...
 * @author peter
 */
public class CoverFront extends Cover {

    public CoverFront(Media media, CoverType type) {
	super(media, type);
    }

    public CoverFront(MediaCollection mediaCol, CoverType type) {
	super(mediaCol, type);
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return CoverFront.class;
    }
