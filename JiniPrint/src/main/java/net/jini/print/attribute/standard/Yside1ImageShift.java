 ...
 * direction of the shift. If the bind edge is along the x-axis, then a bind
 * edge image shift can be accomplished by applying shifts of equal magnitude,
 * and opposite sign, to the "y-side1-image-shift" and "y-side2-image-shift"
 ...
 * </P>
 */
public class Yside1ImageShift extends Dimension implements DocAttribute, PrintRequestAttribute {

    public Yside1ImageShift(int i, UNIT unit) {
	super(i, unit);
    }

    @Override
    public Class<? extends Attribute> getCategory() {
	return Yside1ImageShift.class;
    }

    @Override
    public String getName() {
	return "y-side1-image-shift";
    }
